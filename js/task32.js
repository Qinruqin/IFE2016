window.onload = function(){
    ...
    var initBox = document.getElementById('init-box');
    var inputList = initBox.getElementsByTagName('input');
    var form  = document.getElementById('form');
    var data = [['名称','username'],['密码','psw'],['确认密码','psw2'],['邮箱','email'],['手机','mobile']]; 
    var str = '';
    ...
    function addHtml(element){
        str += '<li><p><label>'+element[0]+'：</label><input type="text" id="'+element[1]+'" name="'+element[1]+'"></p><p class="tip"></p></li>';
        form.innerHTML = str;
        //表单元素的事件
    ...
    addEvent(oBtn,'click',initFn,true);
}